        ...
        <Grid item xs={12} lg={4} classes={{ root: classes.textContainer }}>
          <div>
            <Typography variant="h3" className={classes.title}>
              Seamless Migration from Hyperledger Fabri
            </Typography>
            <Typography variant="h2" className={classes.subtitle}>
              Bring Your Blockchain Applications
              up to the Speed of Business
            </Typography>
            {!mdOrSmaller && (
              <>
              <div className="push-bot6">
                ...
                <Typography variant="h6">
                  Compare smart contracts written on ParallelChain® and Hyperledger Fabric
                </Typography>
                </FutureButton>
              </div>
              <div>
              <Typography variant="h3" className={classes.title}>Build applications on ParallelChain®</Typography>
                <Typography variant="h2" className={classes.subtitle}>
