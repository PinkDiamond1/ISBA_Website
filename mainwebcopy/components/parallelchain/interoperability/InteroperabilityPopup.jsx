...
import TheTextAndCode from './TheTextAndCode';
...
export default function InteroperabilityPopup({ closeBackdrop }) {
    ...
    <Grow in>
      <div className={classes.root}>
        ...
        >
          ...
          />
          Back to ParallelChain®
        </FutureButton>
        <TheTextAndCode>
          <Text className="push-top6 push-bot3">
            This demo is an exerpt from the (under-construction) ParallelChain® Developer Hub.
            In this demo, we compare the implementation of two identical smart contracts in
            ParallelChain® and Hyperledger Fabric. Scroll down to see code snippets.
          </Text>
          <Section>
            <TextHeading>
...
func (sl *StateList) AddState(state StateInterface) error {
  ...
  Find(startKey string, endKey string, searchCriteria string, opts RangeOptions) RangeIterator
  Delete(key string)
...
InteroperabilityPopup.propTypes = {
